...
export default class SubCategoriaHistoricoController {
    ...
    public async cadastrar({ request, response, auth }: HttpContextContract): Promise<any> {
        try {
            ...
            const { categoriaHistoricoId, descricao } = await request.validate(CreateSubCategoriaHistoricoValidator)

            // Insere o registro no banco de dados.
            const subCategoriaHistorico = await SubCategoriaHistorico.create({
                categoriaHistoricoId, descricao, 
    ...
    public async atualizar({ request, response, params, auth }: HttpContextContract): Promise<any> {
        try {
            ...
            subCategoriaHistorico.categoriaHistoricoId = categoriaHistoricoId
