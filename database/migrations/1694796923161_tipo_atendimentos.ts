...
/**
 * Classe de migração para criar a tabela 'tipo_atendimento'.
 *
 * Esta migração verifica se a tabela 'tipo_atendimento' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'tipo_atendimento'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'tipo_atendimento' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'tipo_atendimento' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
