...
/**
 * Classe de migração para criar a tabela 'setor'.
 *
 * Esta migração verifica se a tabela 'setor' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'setor'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'setor' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'setor' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
