...
/**
 * Classe de migração para criar a tabela 'funcao'.
 *
 * Esta migração verifica se a tabela 'funcao' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'funcao'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'funcao' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'funcao' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
