...
/**
 * Classe de migração para criar a tabela 'especie'.
 *
 * Esta migração verifica se a tabela 'especie' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'especie'
   ...
   * Exclui a tabela 'especie' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
