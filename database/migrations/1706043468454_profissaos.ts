...
/**
 * Classe de migração para criar a tabela 'profissao'.
 *
 * Esta migração verifica se a tabela 'profissao' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'profissao'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'profissao' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'profissao' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
