    ...
    if (!hasTable) {
      this.schema.withSchema(this.schemaName)
        .createTable(this.tableName, (table) => {
          ...
          table.time('hora_liberacao').nullable().comment('Data inicial em que o usuário poderá acessar o app.')
          table.time('hora_finalizacao').nullable().comment('Data inicial em que o usuário poderá acessar o app.')
