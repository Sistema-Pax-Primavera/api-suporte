...
/**
 * Classe de migração para criar a tabela 'plano'.
 *
 * Esta migração verifica se a tabela 'plano' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'plano'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'plano' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'plano' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
