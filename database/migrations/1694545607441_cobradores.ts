...
/**
 * Classe de migração para criar a tabela 'cobrador'.
 *
 * Esta migração verifica se a tabela 'cobrador' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'cobrador'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'cobrador' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'cobrador' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
