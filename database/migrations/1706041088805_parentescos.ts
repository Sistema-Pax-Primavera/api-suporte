...
/**
 * Classe de migração para criar a tabela 'parentesco'.
 *
 * Esta migração verifica se a tabela 'parentesco' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'parentesco'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'parentesco' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'parentesco' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
