...
/**
 * Classe de migração para criar a tabela 'rota'.
 *
 * Esta migração verifica se a tabela 'rota' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'rota'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'rota' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'rota' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
