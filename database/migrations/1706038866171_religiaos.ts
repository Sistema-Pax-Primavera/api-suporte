...
/**
 * Classe de migração para criar a tabela 'religiao'.
 *
 * Esta migração verifica se a tabela 'religiao' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'religiao'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'religiao' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'religiao' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
