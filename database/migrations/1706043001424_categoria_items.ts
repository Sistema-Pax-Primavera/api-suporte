...
/**
 * Classe de migração para criar a tabela 'categoria_item'.
 *
 * Esta migração verifica se a tabela 'categoria_item' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'categoria_item'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'categoria_item' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'categoria_item' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
