...
/**
 * Classe de migração para criar a tabela 'estado_civil'.
 *
 * Esta migração verifica se a tabela 'estado_civil' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'estado_civil'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'estado_civil' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'estado_civil' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
