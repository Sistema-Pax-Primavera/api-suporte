...
/**
 * Classe de migração para criar a tabela 'unidades'.
 *
 * Esta migração verifica se a tabela 'unidades' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'unidades'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'unidades' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'unidades' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
