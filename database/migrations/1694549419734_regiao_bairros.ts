...
/**
 * Classe de migração para criar a tabela 'regiao_bairro'.
 *
 * Esta migração verifica se a tabela 'regiao_bairro' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'regiao_bairro'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'regiao_bairro' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'regiao_bairro' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
