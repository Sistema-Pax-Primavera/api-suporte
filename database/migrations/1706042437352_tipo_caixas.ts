...
/**
 * Classe de migração para criar a tabela 'tipo_caixa'.
 *
 * Esta migração verifica se a tabela 'tipo_caixa' já existe no banco de dados.
...
export default class extends BaseSchema {
   ...
   * @type {string}
   */
  protected tableName: string = 'tipo_caixa'

  /**
   * Método 'up' da migração.
   * Cria a tabela 'tipo_caixa' se ela não existir.
   *
   * @public
   ...
   * Exclui a tabela 'tipo_caixa' se ela existir.
   *
   * @public
   * @returns {Promise<void>}
   */
